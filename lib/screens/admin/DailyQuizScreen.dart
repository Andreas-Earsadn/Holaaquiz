...
//  CategoryData selectedCategoryForCategory;
  ...
  Future<void> save() async {
    ...
    if (formKey.currentState!.validate()) {
      ...
      await dailyQuizServices.dailyQuestionListFuture(dateId).then((value) async {
        log(value.createdAt);
        ...
        await dailyQuizServices.updateDocument(quizData.toJson(), dateId).then((value) {
          //
        }).catchError((e) {
          toast(e.toString());
        });
        ...
        await dailyQuizServices.addDocumentWithCustomId(dateId, quizData.toJson()).then((value) {
            ...
            Row(
              ...
              children: [
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Select Questions for Daily Quiz', style: boldTextStyle()),
                    16.height,
                    Container(
                                ...
                                itemBuilder: (index, context, documentSnapshot) {
                                  ...
                                  return Row(
                                    children: [
                                      ...
                                      8.width,
                                      Text(data.questionTitle!, style: secondaryTextStyle()).expand(),
                                    ],
                                  ).paddingAll(8).onTap(() {
                      ...
                      Row(
                        children: [
                          AppTextField(
                            ...
                            focus: dateFocus,
                            decoration: inputDecoration(labelText: 'Pick your Date'),
                            onTap: () {
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      16.width,
                                      Text(data.questionTitle!, maxLines: 3, overflow: TextOverflow.ellipsis, style: secondaryTextStyle()).expand(),
                                    ],
                                  ),
                                ),
                                Align(
                                  child: Container(
                                    ...
                                    decoration: boxDecorationWithRoundedCorners(borderRadius: BorderRadius.circular(8), backgroundColor: appButtonColor),
                                    child: IconButton(
