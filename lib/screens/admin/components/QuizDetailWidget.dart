...
class QuizDetailWidgetState extends State<QuizDetailWidget> {
  ...
  Future<void> init() async {
    widget.data!.questionRef!.forEach((e) async {
      await questionServices.questionById(e).then((value) {
        ...
        child: Column(
          ...
          children: [
            ...
            Wrap(
              ...
              spacing: 16,
              children: [
                itemWidget(colorPrimary, white, 'Quiz Time', '${widget.data!.quizTime.validate()} Minutes'),
                itemWidget(colorPrimary, white, 'Required point', widget.data!.minRequiredPoint.toString()),
